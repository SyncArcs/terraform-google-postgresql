...
module "postgresql-db" {
  source               = "https://github.com/SyncArcs/terraform-google-postgresql.git?ref=v1.0.0"
  name                 = "testdb"
  environment          = "test"
  db_name              = "postgresql"
...
## Examples
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/SyncArcs/terraform-google-postgresql/tree/master/examples) directory within this repository.
...
## License
This project is licensed under the **MIT** License - see the [LICENSE](https://github.com/SyncArcs/terraform-google-postgresql/blob/master/LICENSE) file for details.
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/SyncArcs/terraform-google-postgresql"` | no |
